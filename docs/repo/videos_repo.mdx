...
import {Gallery} from '@site/docs/_jscripts/gallery.js'
...
export const titles_repo = ["Adding data", "Creating collaborators", "Data assignment"]
export const remarks_repo = ["The right places to add your add", "Necessary for adding authors to data publications",  "Part A"]

<Gallery
links={links_repo}
titles={titles_repo}
remarks={remarks_repo}
/>
